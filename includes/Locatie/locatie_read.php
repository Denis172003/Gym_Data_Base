    ...
    <div class="container p-3 my-5 bg-light border border-primary">
        ...
        try {
            ...
            if ($result) {
                ...
                echo "<thead><tr><th>ID_LOCATIE</th><th>STRADA_LOCATIE</th><th>NUMAR_STRADA</th><th>ORAS</th><th>NUME_LOCATIE</th></tr></thead><tbody>";

                foreach ($result as $row) {
                    echo "<tr>";
                    echo "<td>" . $row['id_locatie'] . "</td>";
                    echo "<td>" . $row['strada_locatie'] . "</td>";
