    ...
    <div class="container p-3 my-5 bg-light border border-primary">
        ...
        try {
            ...
            if ($result) {
                ...
                echo "<thead><tr><th>ID_PRODUS</th><th>ID_DEPARTAMENT</th><th>ID_PROMOTIE</th><th>NUME_PRODUS</th><th>GRAMAJ</th><th>VALOARE_NUTRITIONALA</th></tr></thead><tbody>";

                foreach ($result as $row) {
                    echo "<tr>";
                    echo "<td>" . $row['id_produs'] . "</td>";
                    echo "<td>" . $row['id_departament'] . "</td>";
                    echo "<td>" . $row['id_promotie'] . "</td>";
                    echo "<td>" . $row['nume_produs'] . "</td>";
                    echo "<td>" . $row['gramaj'] . "</td>";
                    echo "<td>" . $row['valoare_nutritionala'] . "</td>";
                    echo "</tr>";
                }
